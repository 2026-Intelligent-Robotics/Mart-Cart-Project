...
class LaunchArguments(LaunchArgumentsBase):
    ...
    end_effector: DeclareLaunchArgument = DeclareLaunchArgument(
        'end_effector',
        default_value='pal-gripper',
        description='End effector model for TIAGO'
    )
...
def declare_actions(
    ...
    robot_spawn = include_scoped_launch_py_description(
        ...
        launch_arguments={
            ...
            'torso_lift_joint_position': LaunchConfiguration('torso_lift_joint_position'),
        }
    )
    ...
    tiago_bringup = include_scoped_launch_py_description(
        ...
        launch_arguments={
            ...
            "arm_motor_model": LaunchConfiguration("arm_motor_model"),
